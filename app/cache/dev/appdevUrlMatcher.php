...
class appdevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // pincrowd_api_scoring
        if (0 === strpos($pathinfo, '/score') && preg_match('#^/score/(?<laneId>[^/]+)$#s', $pathinfo, $matches)) {
            if (!in_array($this->context->getMethod(), array('GET', 'HEAD'))) {
                $allow = array_merge($allow, array('GET', 'HEAD'));
                goto not_pincrowd_api_scoring;
            }

            return array_merge($this->mergeDefaults($matches, array (  '_controller' => 'PinCrowd\\Api\\ScoringBundle\\Controller\\ScoringController::getScoreAction',  '_format' => 'json',  '_locale' => 'en',)), array('_route' => 'pincrowd_api_scoring'));
        }
        not_pincrowd_api_scoring:
